...
import { dunyaHavayollariI18n } from "./i18n/dunya-havayollari";
 ...
 */
const dunyaHavayollari: PackConfig = {
  id: "dunya-havayollari",
  ...
  i18n: dunyaHavayollariI18n,
};

export default dunyaHavayollari;
