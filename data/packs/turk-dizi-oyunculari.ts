...
import { turkDiziOyunculariI18n } from "./i18n/turk-dizi-oyunculari";
 ...
 */
const turkDiziOyunculari: PackConfig = {
  id: "turk-dizi-oyunculari",
  ...
  i18n: turkDiziOyunculariI18n,
};

export default turkDiziOyunculari;
